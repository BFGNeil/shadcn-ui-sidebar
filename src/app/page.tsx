      ...
      <header className="z-[50] sticky top-0 w-full bg-background/95 border-b backdrop-blur-sm dark:bg-black/[0.6] border-border/40">
        <div className="container h-14 flex items-center">
          ...
          >
            ...
            <span className="font-bold">Indoor Tracker</span>
            <span className="sr-only">GPS + WIFI + BLE indoor & outdoor positioning</span>
          </Link>
        ...
        <div className="container relative pb-10">
          <section className="mx-auto flex max-w-[980px] flex-col items-center gap-2 py-8 md:py-12 md:pb-8 lg:py-24 lg:pb-6">
            <h1 className="text-center text-3xl font-bold leading-tight tracking-tighter md:text-5xl lg:leading-[1.1]">
              Indoor tracking made easy
            </h1>
            <span className="max-w-[750px] text-center text-lg font-light text-foreground">
              Indoor Tracker is a web-based application that provides a simple way to track
              indoor and outdoor locations using GPS, WIFI, and BLE technologies.
            </span>
      ...
      <footer className="py-6 md:py-0 border-t border-border/40">
        <div className="container flex flex-col items-center justify-center gap-4 md:h-24 md:flex-row">
          <p className="text-balance text-center text-sm leading-loose text-muted-foreground">
            © 2024 Indoor Tracker. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
